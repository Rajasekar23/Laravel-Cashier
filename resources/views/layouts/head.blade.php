<meta charset="utf-8">
      ...
      <link rel="stylesheet" type="text/css" href="{{ Vite::asset('resources/css/bootstrap.min.css') }}">
      <!-- style css -->
      ...
      <link rel="stylesheet" href="{{ Vite::asset('resources/css/jquery.mCustomScrollbar.min.css') }}">
      ...
      <link rel="stylesoeet" href="{{ Vite::asset('resources/css/owl.theme.default.min.css') }}">
